...

{
    ...
    case TX_32X16:
        ...
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_32x16_N2(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_32x16_N2_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_16X32:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_16x32_N2(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_16x32_N2_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_16X8:
        eb_av1_fwd_txfm2d_16x8_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_8X16:
        eb_av1_fwd_txfm2d_8x16_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_32X8:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_32x8_N2(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_32x8_N2_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_8X32:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_8x32_N2(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_8x32_N2_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_16X4:
        eb_av1_fwd_txfm2d_16x4_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_4X16:
        eb_av1_fwd_txfm2d_4x16_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_8X4:

        eb_av1_fwd_txfm2d_8x4_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_4X8:

        eb_av1_fwd_txfm2d_4x8_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
    ...
    case TX_16X16:
        ...
        eb_av1_fwd_txfm2d_16x16_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_8X8:

        eb_av1_fwd_txfm2d_8x8_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_4X4:

        eb_av1_fwd_txfm2d_4x4_N2(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
...

{
    ...
    case TX_32X16:
        // TTK
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_32x16_N4(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_32x16_N4_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_16X32:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_16x32_N4(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_16x32_N4_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_16X8:
        eb_av1_fwd_txfm2d_16x8_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_8X16:
        eb_av1_fwd_txfm2d_8x16_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_32X8:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_32x8_N4(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_32x8_N4_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;

    case TX_8X32:
        if ((transform_type == DCT_DCT) || (transform_type == IDTX))
            eb_av1_fwd_txfm2d_8x32_N4(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        else
            eb_av1_fwd_txfm2d_8x32_N4_c(
                residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_16X4:
        eb_av1_fwd_txfm2d_16x4_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_4X16:
        eb_av1_fwd_txfm2d_4x16_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
        break;
    case TX_8X4:

        eb_av1_fwd_txfm2d_8x4_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_4X8:

        eb_av1_fwd_txfm2d_4x8_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
    ...
    case TX_16X16:
        ...
        eb_av1_fwd_txfm2d_16x16_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_8X8:

        eb_av1_fwd_txfm2d_8x8_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);

        break;
    case TX_4X4:

        eb_av1_fwd_txfm2d_4x4_N4(
            residual_buffer, coeff_buffer, residual_stride, transform_type, bit_depth);
...
#if PARTIAL_FREQUENCY
void eb_av1_fidentity16_N2_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                             const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fadst16_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                           const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fdct16_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity8_N2_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                            const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fadst8_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fdct8_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                         const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity4_N2_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                            const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fadst4_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    int32_t        bit   = cos_bit;
    const int32_t *sinpi = sinpi_arr(bit);
...
void eb_av1_fdct4_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                         const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fdct32_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity32_N2_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                             const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fdct64_new_N2(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
static INLINE TxfmFunc fwd_txfm_type_to_func_N2(TxfmType txfmtype) {
    switch (txfmtype) {
    case TXFM_TYPE_DCT4: return eb_av1_fdct4_new_N2;
    case TXFM_TYPE_DCT8: return eb_av1_fdct8_new_N2;
    case TXFM_TYPE_DCT16: return eb_av1_fdct16_new_N2;
    case TXFM_TYPE_DCT32: return eb_av1_fdct32_new_N2;
    case TXFM_TYPE_DCT64: return eb_av1_fdct64_new_N2;
    case TXFM_TYPE_ADST4: return eb_av1_fadst4_new_N2;
    case TXFM_TYPE_ADST8: return eb_av1_fadst8_new_N2;
    case TXFM_TYPE_ADST16: return eb_av1_fadst16_new_N2;
    case TXFM_TYPE_ADST32: return av1_fadst32_new;
    case TXFM_TYPE_IDENTITY4: return eb_av1_fidentity4_N2_c;
    case TXFM_TYPE_IDENTITY8: return eb_av1_fidentity8_N2_c;
    case TXFM_TYPE_IDENTITY16: return eb_av1_fidentity16_N2_c;
    case TXFM_TYPE_IDENTITY32: return eb_av1_fidentity32_N2_c;
...
static INLINE void av1_tranform_two_d_core_N2_c(int16_t *input, uint32_t input_stride,
    ...
    for (c = 0; c < txfm_size_col; ++c) {
        ...
        txfm_func_col(temp_in, temp_out, cos_bit_col, stage_range_col);
        eb_av1_round_shift_array_c(
            temp_out, txfm_size_row / 2, -shift[1]); // NM eb_av1_round_shift_array_c
        if (cfg->lr_flip == 0) {
            for (r = 0; r < txfm_size_row; ++r) buf[r * txfm_size_col + c] = temp_out[r];
        } else {
            for (r = 0; r < txfm_size_row; ++r)
    ...
    for (r = 0; r < txfm_size_row / 2; ++r) {
        txfm_func_row(
            buf + r * txfm_size_col, output + r * txfm_size_col, cos_bit_row, stage_range_row);
        eb_av1_round_shift_array_c(output + r * txfm_size_col, txfm_size_col / 2, -shift[2]);
...
void eb_av1_fwd_txfm2d_64x32_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[64 * 32];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_64X32, &cfg);
...
void eb_av1_fwd_txfm2d_32x64_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 64];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_32X64, &cfg);
...
void eb_av1_fwd_txfm2d_64x16_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[64 * 16];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_64X16, &cfg);
...
void eb_av1_fwd_txfm2d_16x64_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 64];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_16X64, &cfg);
...
void eb_av1_fwd_txfm2d_32x16_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 16];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_16x32_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 32];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_16x8_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 8];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_8x16_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 16];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_32x8_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 8];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_8x32_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 32];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_16x4_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 4];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_4x16_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[4 * 16];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_8x4_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 4];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fwd_txfm2d_4x8_N2_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[4 * 8];
    Txfm2dFlipCfg cfg;
...
void eb_av1_fdct4_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                         const int8_t *stage_range) {
    (void)stage_range;
...
void eb_av1_fadst4_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    int32_t        bit   = cos_bit;
    const int32_t *sinpi = sinpi_arr(bit);
...
void eb_av1_fidentity4_N4_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                            const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
    output[0] = round_shift((int64_t)input[0] * new_sqrt2, new_sqrt2_bits);
...
void eb_av1_fdct8_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                         const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fadst8_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity8_N4_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                            const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fdct16_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fadst16_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                           const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity16_N4_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                             const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
    for (int32_t i = 0; i < 4; ++i)
...
void eb_av1_fdct32_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
void eb_av1_fidentity32_N4_c(const int32_t *input, int32_t *output, int8_t cos_bit,
                             const int8_t *stage_range) {
    (void)stage_range;
    (void)cos_bit;
...
void eb_av1_fdct64_new_N4(const int32_t *input, int32_t *output, int8_t cos_bit,
                          const int8_t *stage_range) {
    (void)stage_range;
    const int32_t *cospi;
...
static INLINE TxfmFunc fwd_txfm_type_to_func_N4(TxfmType txfmtype) {
    switch (txfmtype) {
    case TXFM_TYPE_DCT4: return eb_av1_fdct4_new_N4;
    case TXFM_TYPE_DCT8: return eb_av1_fdct8_new_N4;
    case TXFM_TYPE_DCT16: return eb_av1_fdct16_new_N4;
    case TXFM_TYPE_DCT32: return eb_av1_fdct32_new_N4;
    case TXFM_TYPE_DCT64: return eb_av1_fdct64_new_N4;
    case TXFM_TYPE_ADST4: return eb_av1_fadst4_new_N4;
    case TXFM_TYPE_ADST8: return eb_av1_fadst8_new_N4;
    case TXFM_TYPE_ADST16: return eb_av1_fadst16_new_N4;
    case TXFM_TYPE_ADST32: return av1_fadst32_new;
    case TXFM_TYPE_IDENTITY4: return eb_av1_fidentity4_N4_c;
    case TXFM_TYPE_IDENTITY8: return eb_av1_fidentity8_N4_c;
    case TXFM_TYPE_IDENTITY16: return eb_av1_fidentity16_N4_c;
    case TXFM_TYPE_IDENTITY32: return eb_av1_fidentity32_N4_c;
...
static INLINE void av1_tranform_two_d_core_N4_c(int16_t *input, uint32_t input_stride,
    ...
    for (c = 0; c < txfm_size_col; ++c) {
        ...
        txfm_func_col(temp_in, temp_out, cos_bit_col, stage_range_col);
        eb_av1_round_shift_array_c(
            temp_out, txfm_size_row / 4, -shift[1]); // NM eb_av1_round_shift_array_c
        if (cfg->lr_flip == 0) {
            for (r = 0; r < txfm_size_row; ++r) buf[r * txfm_size_col + c] = temp_out[r];
        } else {
            for (r = 0; r < txfm_size_row; ++r)
    ...
    for (r = 0; r < txfm_size_row / 4; ++r) {
        txfm_func_row(
            buf + r * txfm_size_col, output + r * txfm_size_col, cos_bit_row, stage_range_row);
        eb_av1_round_shift_array_c(output + r * txfm_size_col, txfm_size_col / 4, -shift[2]);
...
void eb_av1_fwd_txfm2d_64x32_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[64 * 32];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_64X32, &cfg);
...
void eb_av1_fwd_txfm2d_32x64_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 64];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_32X64, &cfg);
...
void eb_av1_fwd_txfm2d_64x16_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[64 * 16];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_64X16, &cfg);
...
void eb_av1_fwd_txfm2d_16x64_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 64];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_16X64, &cfg);
...
void eb_av1_fwd_txfm2d_32x16_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 16];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_32X16, &cfg);
...
void eb_av1_fwd_txfm2d_16x32_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                  TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 32];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_16X32, &cfg);
...
void eb_av1_fwd_txfm2d_16x8_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 8];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_16X8, &cfg);
...
void eb_av1_fwd_txfm2d_8x16_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 16];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_8X16, &cfg);
...
void eb_av1_fwd_txfm2d_32x8_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[32 * 8];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_32X8, &cfg);
...
void eb_av1_fwd_txfm2d_8x32_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 32];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_8X32, &cfg);
...
void eb_av1_fwd_txfm2d_16x4_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[16 * 4];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_16X4, &cfg);
...
void eb_av1_fwd_txfm2d_4x16_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                 TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[4 * 16];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_4X16, &cfg);
...
void eb_av1_fwd_txfm2d_8x4_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[8 * 4];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_8X4, &cfg);
...
void eb_av1_fwd_txfm2d_4x8_N4_c(int16_t *input, int32_t *output, uint32_t input_stride,
                                TxType transform_type, uint8_t bit_depth) {
    int32_t       intermediate_transform_buffer[4 * 8];
    Txfm2dFlipCfg cfg;
    av1_transform_config(transform_type, TX_4X8, &cfg);
