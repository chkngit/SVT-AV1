...
static AOM_FORCE_INLINE void load_buffer_16x16_N2_H(const int16_t *input, __m256i *out, int32_t stride,
                                          int32_t flipud, int32_t fliplr, int32_t shift) {
    // Load 4 8x8 blocks
    const int16_t *top_l = input;
    const int16_t *top_r = input + 8;
...
static void fdct4x8_col_N2_avx2(__m256i *in, __m256i *output, int32_t bit,
                                       const int32_t num_col) {
    const int32_t *cospi   = cospi_arr(bit);
    const __m256i  zero    = _mm256_setzero_si256();
    const __m256i  cospi32 = _mm256_set1_epi32(cospi[32]);
...
static void fadst4x8_col_N2_avx2(__m256i *in, __m256i *output, int32_t bit,
                                        const int32_t num_col) {
    const int32_t *sinpi  = sinpi_arr(bit);
    const __m256i  zero   = _mm256_setzero_si256();
    const __m256i  rnding = _mm256_set1_epi32(1 << (bit - 1));
...
static void fadst8x4_N2_avx2(__m256i *input, __m256i *output, int32_t bit,
                                    const int32_t col_num) {
    __m128i *      in       = (__m128i *)input;
    __m128i *      out      = (__m128i *)output;
    const int32_t *cospi    = cospi_arr(bit);
...
void eb_av1_fwd_txfm2d_8x8_N2_avx2(int16_t *input, int32_t *coeff, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i       in[8], out[8];
    const int8_t *shift   = fwd_txfm_shift_ls[TX_8X8];
    const int32_t txw_idx = get_txw_idx(TX_8X8);
...
void eb_av1_fwd_txfm2d_16x16_N2_avx2(int16_t *input, int32_t *coeff, uint32_t stride,
...
void eb_av1_fwd_txfm2d_64x64_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)bd;
    __m256i       in[512];
    __m256i *     out     = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_32x32_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
...
void eb_av1_fwd_txfm2d_16x32_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[64];
    __m256i *     outcoef256    = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_16X32];
...
/* call this function only for IDTX */
void eb_av1_fwd_txfm2d_32x16_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[64];
    __m256i *     outcoef256    = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_32X16];
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_8x32_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[32];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_8X32];
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_32x8_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[32];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_32X8];
...
/* call this function for all 16 transform types */
void eb_av1_fwd_txfm2d_8x16_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[16], out[16];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_8X16];
    ...
    case FLIPADST_ADST:
        ...
        break;
    case IDTX:
        load_buffer_8x8(input, in, stride, ud_flip, lr_flip, shift[0]);
...
/* call this function for all 16 transform types */
void eb_av1_fwd_txfm2d_16x8_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[16], out[16];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_16X8];
    ...
    case DCT_DCT:
        ...
        if (lr_flip) {
            for (int32_t i = 0; i < 16; i++) in[16 - i - 1] = out[i];
            fdct16x16_N2_avx2(in, out, bitrow, num_row, 1);
        } else
    ...
    case FLIPADST_ADST:
        ...
        break;
    case IDTX:
        load_buffer_8x8(input, in, stride, ud_flip, 0, shift[0]);
        fidtx8x8_N2_avx2(in, out, bitcol, 1);
        col_txfm_8x8_N2_rounding(out, -shift[1]);
        if (lr_flip) {
            for (int32_t i = 0; i < 16; i++) in[16 - i - 1] = out[i];
            fidtx8xn_N2_col_avx2(in, out, bitrow, 4);
        } else
    ...
    case H_FLIPADST:
        ...
        if (lr_flip) {
            ...
            fadst16x16_avx2(out, out, bitrow, num_row);
        transpose_8x8_avx2(out, in);
        av1_round_shift_rect_array_32_avx2(in, out, 4, -shift[2], new_sqrt2);
        write_buffer_16x8_N2_avx2(out, outcoef256);
        clear_buffer_wxh_N2(outcoef256, num_col, txfm_size_row);
...
void eb_av1_fwd_txfm2d_4x8_N2_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i in[4];
    __m256i outcoeff256[4];
...
void eb_av1_fwd_txfm2d_8x4_N2_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i       in[4];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_txfm_shift_ls[TX_8X4];
...
void eb_av1_fwd_txfm2d_4x16_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[8];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_txfm_shift_ls[TX_4X16];
...
void eb_av1_fwd_txfm2d_16x4_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[8];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_shift_16x4;
...
void eb_av1_fwd_txfm2d_32x64_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
    __m256i *     outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_64x32_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
    __m256i *     outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_16x64_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[128];
    __m256i *     outcoeff256   = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_16X64];
...
void eb_av1_fwd_txfm2d_64x16_N2_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[128];
    __m256i *     outcoeff256   = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_64X16];
...
static void fdct4x8_col_N4_avx2(__m256i *in, __m256i *output, int32_t bit,
                                       const int32_t num_col) {
    const int32_t *cospi   = cospi_arr(bit);
    const __m256i  zero    = _mm256_setzero_si256();
    const __m256i  cospi32 = _mm256_set1_epi32(cospi[32]);
...
static void fadst8x4_N4_avx2(__m256i *input, __m256i *output, int32_t bit,
                                    const int32_t col_num) {
    __m128i *      in       = (__m128i *)input;
    __m128i *      out      = (__m128i *)output;
    const int32_t *cospi    = cospi_arr(bit);
...
void eb_av1_fwd_txfm2d_8x8_N4_avx2(int16_t *input, int32_t *coeff, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i       in[8], out[8];
    const int8_t *shift   = fwd_txfm_shift_ls[TX_8X8];
    const int32_t txw_idx = get_txw_idx(TX_8X8);
...
void eb_av1_fwd_txfm2d_16x16_N4_avx2(int16_t *input, int32_t *coeff, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[32], out[32];
    const int8_t *shift   = fwd_txfm_shift_ls[TX_16X16];
    const int32_t txw_idx = get_txw_idx(TX_16X16);
...
void eb_av1_fwd_txfm2d_64x64_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)bd;
    __m256i       in[512];
    __m256i *     out     = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_32x32_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    const int8_t *shift           = fwd_txfm_shift_ls[TX_32X32];
    const int32_t txw_idx         = tx_size_wide_log2[TX_32X32] - tx_size_wide_log2[0];
    const int32_t txh_idx         = tx_size_high_log2[TX_32X32] - tx_size_high_log2[0];
...
void eb_av1_fwd_txfm2d_16x32_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[64];
    __m256i *     outcoef256    = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_16X32];
...
/* call this function only for IDTX */
void eb_av1_fwd_txfm2d_32x16_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[64];
    __m256i *     outcoef256    = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_32X16];
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_8x32_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[32];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_8X32];
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_32x8_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[32];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_32X8];
...
/* call this function for all 16 transform types */
void eb_av1_fwd_txfm2d_8x16_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[16], out[16];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_8X16];
...
/* call this function for all 16 transform types */
void eb_av1_fwd_txfm2d_16x8_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[16], out[16];
    __m256i *     outcoef256 = (__m256i *)output;
    const int8_t *shift      = fwd_txfm_shift_ls[TX_16X8];
    ...
    case DCT_DCT:
        ...
        if (lr_flip) {
            for (int32_t i = 0; i < 16; i++) in[16 - i - 1] = out[i];
            fdct16x16_N4_avx2(in, out, bitrow, num_row, 1);
        } else
    ...
    case IDTX:
        ...
        if (lr_flip) {
            for (int32_t i = 0; i < 16; i++) in[16 - i - 1] = out[i];
            fidtx8xn_N2_col_avx2(in, out, bitrow, 2);
        } else
...
void eb_av1_fwd_txfm2d_4x8_N4_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i in[4];
    __m256i outcoeff256[4];
...
void eb_av1_fwd_txfm2d_8x4_N4_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                   uint8_t bd) {
    __m256i       in[4];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_txfm_shift_ls[TX_8X4];
...
void eb_av1_fwd_txfm2d_4x16_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[8];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_txfm_shift_ls[TX_4X16];
...
void eb_av1_fwd_txfm2d_16x4_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                    TxType tx_type, uint8_t bd) {
    __m256i       in[8];
    __m256i *     outcoeff256 = (__m256i *)output;
    const int8_t *shift       = fwd_shift_16x4;
...
void eb_av1_fwd_txfm2d_32x64_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
    __m256i *     outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_64x32_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
    __m256i *     outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_16x64_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[128];
    __m256i *     outcoeff256   = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_16X64];
...
void eb_av1_fwd_txfm2d_64x16_N4_avx2(int16_t *input, int32_t *output, uint32_t stride,
                                     TxType tx_type, uint8_t bd) {
    __m256i       in[128];
    __m256i *     outcoeff256   = (__m256i *)output;
    const int8_t *shift         = fwd_txfm_shift_ls[TX_64X16];
